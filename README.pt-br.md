...
1. Procure o “BotFather” no Telegram.
2. Inicie um chat e envie `/newbot` para criar um novo bot.
3. Dê um nome e nome de usuário ao seu bot.
4. Assim que o bot for criado, o BotFather lhe dará um token. Este token é usado para autenticar e interagir com a API do Telegram.

Lembre-se de usar o painel Secrets para configurar o bot e experimentá-lo você mesmo.
